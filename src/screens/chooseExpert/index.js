  ...
  fetchData() {
    ...
    const params = {
      expertsParams: {
        ...
        roleValue:
          Constant.App.firebaseTableKeyValuesNames.expertsConditionValue,
      },
    };
    getExperts(params);
  }
  ...
  renderQuestionView() {
    ...
    return (
      <View style={styles.questionParentContainer}>
        ...
        <CustomText style={styles.questionTextStyle}>{question}</CustomText>
        <TouchableOpacity
          onPress={() => {
            this.setState({
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                const filterParams = {
                  ...
                  roleValue:
                    Constant.App.firebaseTableKeyValuesNames
                      .expertsConditionValue,
                  professionKey:
                    Constant.App.firebaseTableKeyValuesNames
                      .filterConditionProfessionKey,
            ...
            {genderItemsArr.map((item, key) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  genderItemsArr[key].selected = genderItemsArr[key].selected
                    ? false
                    : true;
                  this.setState({
              ...
              >
                <View style={styles.filterModalItemContainerStyle}>
                  <Image
                    ...
                    source={
                      item.selected
                        ? staticImages.radioCheckBlueIcon
                        : staticImages.radioUnCheckBlueIcon
                    }
            ...
            {professionData.map((item, key) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  //   }
                  // });
                  professionData[key].selected = professionData[key].selected
                    ? false
                    : true;
                  this.setState({
          ...
          <View style={styles.filterModalLangParentContainerStyle}>
            ...
            {languagesData.map((item, key) => (
              <TouchableOpacity
                key={key}
                onPress={() => {
                  languagesData[key].selected = languagesData[key].selected
                    ? false
                    : true;
                  this.setState({
