...
class ChatBot extends Component {
  ...
  onButtonPress = () => {
    ...
    console.log(this.state.currentChat.trigger);
  ...
  render() {
    ...
    const { chatHeader, imagesArray } = this.props;
    ...
    return (
      <View style={styles.viewStyle}>
        ...
        <ChatFooter
          userInput={showUserInput}
          contentChangeCallback={this.onContentSizeChange}
          value={userText}
          ...
          multipleOptionsSelect={currentChat.multipleOptionsSelect}
          options={currentChat.options}
          onChoiceCallback={this.onChoiceTouch}
          onSliderCallback={this.onSliderValue}
          maximumValue={sliderMax}
          sliderArray={currentChat.slider}
          chatInputButtonDisabled={chatInputButtonDisabled}
