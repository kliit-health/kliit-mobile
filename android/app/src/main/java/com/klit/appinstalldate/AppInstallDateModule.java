...
package com.klit.appinstalldate;
...
public class AppInstallDateModule extends ReactContextBaseJavaModule {
    ...
    public AppInstallDateModule(ReactApplicationContext context) {
    ...
    public void getInstallDate () {
        ...
        try{
            ...
            String dateString = DateFormat.format("MM/dd/yyyy hh:mm:ss", new Date(installedTime)).toString();
